...
def create_scrape_request_log():
    ...
    flow = 'refresh_instagram_gpt_data_base_categ_lang_topics'
...
with DAG(
        dag_id='sync_instagram_gpt_data_base_categ_lang_topics',
    ...
    task = PythonOperator(
        task_id='create_instagram_gpt_data_base_categ_lang_topics_scl',
