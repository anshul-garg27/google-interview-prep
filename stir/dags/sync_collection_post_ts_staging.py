        ...
        sql=(
            '''
                ...
                select 
                    ...
                    total_engagement,
                    engagement_rate
                from dbt.mart_staging_collection_post_ts
    ...
    import_to_pg_db = PostgresOperator(
        ...
        sql="""
                ...
                INSERT INTO collection_post_metrics_ts_tmp
                    ...
                    set platform_account_code = ia.id, profile_pic = ia.thumbnail
                    from instagram_account ia
                    where ia.ig_id = profile_social_id;
                    
                    update collection_post_metrics_ts_tmp
                    set platform_account_code = ya.id, profile_pic = ya.thumbnail
