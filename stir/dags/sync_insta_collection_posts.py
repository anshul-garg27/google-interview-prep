...
def create_scrape_request_log():
    ...
    posts = client.query('''with 
                                posts_to_scrape as (
                                    ...
                                    where platform = 'INSTAGRAM' and post_type IN ('reels', 'image', 'carousel')
                                ...
                                attempted_recently as (
                                    ...
                                    where flow = 'refresh_post_by_shortcode' and event_timestamp >= now() - INTERVAL 12 HOUR
                                ),
                                failures as (
                                    SELECT
                                        JSONExtractString(params, 'shortcode') as shortcode
                                ...
                                candiate_set as (
                                    ...
                                    where 
                                        ...
                                        and (publish_time is null or publish_time >= now() - INTERVAL 14 DAY)
                                )
