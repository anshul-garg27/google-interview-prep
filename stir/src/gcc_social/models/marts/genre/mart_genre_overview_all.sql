{{ config(materialized = 'table', tags=["disabled"], order_by='month, category') }}
with
Idata as (
...
ia_base as (
    ...
    where base.month >= date('2022-01-01')
...
inst_and_yt as (
    select
        ...
        sum(female_gender) female_gender,
        map(
            '13-17', COALESCE(round(m_13_17/demo_followers, 2), 0.0),
            '18-24', COALESCE(round(m_18_24/demo_followers, 2), 0.0),
            '25-34', COALESCE(round(m_25_34/demo_followers, 2), 0.0),
            '35-44', COALESCE(round(m_35_44/demo_followers, 2), 0.0),
            '45-54', COALESCE(round(m_45_54/demo_followers, 2), 0.0),
            '55-64', COALESCE(round(m_55_64/demo_followers, 2), 0.0),
            '65+', COALESCE(round(m_65_plus/demo_followers, 2), 0.0)) male_audience_age_gender,
        map(
            '13-17', COALESCE(round(f_13_17/demo_followers, 2), 0.0),
            '18-24', COALESCE(round(f_18_24/demo_followers, 2), 0.0),
            '25-34', COALESCE(round(f_25_34/demo_followers, 2), 0.0),
            '35-44', COALESCE(round(f_35_44/demo_followers, 2), 0.0),
            '45-54', COALESCE(round(f_45_54/demo_followers, 2), 0.0),
            '55-64', COALESCE(round(f_55_64/demo_followers, 2), 0.0),
            '65+', COALESCE(round(f_65_plus/demo_followers, 2), 0.0)) female_audience_age_gender,
        map(
            'male', male_audience_age_gender,
            'female', female_audience_age_gender
        ) audience_age_gender,
        map(
            '13-17', COALESCE(round(a_13_17/demo_followers, 2), 0.0),
            '18-24', COALESCE(round(a_18_24/demo_followers, 2), 0.0),
            '25-34', COALESCE(round(a_25_34/demo_followers, 2), 0.0),
            '35-44', COALESCE(round(a_35_44/demo_followers, 2), 0.0),
            '45-54', COALESCE(round(a_45_54/demo_followers, 2), 0.0),
            '55-64', COALESCE(round(a_55_64/demo_followers, 2), 0.0),
            '65+', COALESCE(round(a_65_plus/demo_followers, 2), 0.0)
        ) audience_age,
        map(
            'male_per', COALESCE(round(male_gender/demo_followers, 2), 0.0),
            'female_per', COALESCE(round(female_gender/demo_followers, 2), 0.0)
        ) audience_gender
    from conbined
